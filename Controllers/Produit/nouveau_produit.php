<?php
session_start();
include_once('/opt/lampp/htdocs/Station-Essence/Models/Produit/nouveau_produit.php');
include_once("/opt/lampp/htdocs/Station-Essence/Models/db.php");
...
try {
    ...
    header("Location: /Station-Essence/?page=nouveau_produit");
} finally {
    exit();
}
?>
